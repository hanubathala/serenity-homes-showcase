...
const FloorPlansSection = () => {
  ...
  return (
    <>
      <section id="floorplans" className="py-20 md:py-22 px-6" style={{ background: "var(--section-gradient)" }}>
        <div className="container mx-auto text-center">
          ...
          <div
            className="bg-card rounded-2xl shadow-lg p-4 max-w-4xl mx-auto cursor-zoom-in"
