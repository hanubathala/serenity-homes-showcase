...
const ModelHouseSection = () => {
  ...
  return (
    <>
      <section id="modelhouse" className="py-20 md:py-22 px-6 bg-[#fcf8f2]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {modelHouseImages.map((image, index) => (
              <div
                ...
                className="group cursor-pointer rounded-xl overflow-hidden border border-border shadow-sm hover:shadow-md transition-all"
              >
